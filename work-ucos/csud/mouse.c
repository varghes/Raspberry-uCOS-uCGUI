...
//	LOG_DEBUG("CSUD: Mouse Poll \n"); 
	...
	if (MouseReport->Type == Input) {
		...
		LOGF("MOUSE: %d,%d,%d,%d,%d,%d\n",MouseReport->ReportBuffer[0],MouseReport->ReportBuffer[1],MouseReport->ReportBuffer[2],MouseReport->ReportBuffer[3],MouseReport->ReportBuffer[4],MouseReport->ReportBuffer[5]);
	}
